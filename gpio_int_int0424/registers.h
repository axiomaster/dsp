...
/***************************************************************************************/
/*	CPU registers					*/
cregister volatile unsigned int ICR;
...
/***************************************************************************************/
/*   GPIO registers              */
#define GPIO_REVID		*(volatile unsigned int*)(SOC_GPIO_REGS + 0x0)
#define GPIO_BINTEN		*(volatile unsigned int*)(SOC_GPIO_REGS + 0x8)
#define GPIO_DIR(n)		*(volatile unsigned int*)(SOC_GPIO_REGS + 0x10 + (0x28 * n))
//#define GPIO_DIR(0)		*(volatile unsigned int*)(0x01E26010)
#define GPIO_OUT_DATA(n)	*(volatile unsigned int*)(SOC_GPIO_REGS + 0x14 + (0x28 * n))
#define GPIO_SET_DATA(n)	*(volatile unsigned int*)(SOC_GPIO_REGS + 0x18 + (0x28 * n))
#define GPIO_CLR_DATA(n)	*(volatile unsigned int*)(SOC_GPIO_REGS + 0x1C + (0x28 * n))
#define GPIO_IN_DATA(n)		*(volatile unsigned int*)(SOC_GPIO_REGS + 0x20 + (0x28 * n))
#define GPIO_SET_RIS_TRIG(n)	*(volatile unsigned int*)(SOC_GPIO_REGS + 0x24 + (0x28 * n))
#define GPIO_CLR_RIS_TRIG(n)	*(volatile unsigned int*)(SOC_GPIO_REGS + 0x28 + (0x28 * n))
#define GPIO_SET_FAL_TRIG(n)	*(volatile unsigned int*)(SOC_GPIO_REGS + 0x2C + (0x28 * n))
#define GPIO_CLR_FAL_TRIG(n)	*(volatile unsigned int*)(SOC_GPIO_REGS + 0x30 + (0x28 * n))
#define GPIO_INTSTAT(n)		*(volatile unsigned int*)(SOC_GPIO_REGS + 0x34 + (0x28 * n))
...
/*******************************SPI0 registers*******************************************/
#define SPI_SPIGCR0		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x00)
#define SPI_SPIGCR1		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x04)
#define SPI_SPIINT0		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x08)
#define SPI_SPILVL		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x0C)
#define SPI_SPIFLG		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x10)
#define SPI_SPIPC(n)	*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x14 + (4 * n))
#define SPI_SPIDAT0		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x38)
#define SPI_SPIDAT1		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x3C)
#define SPI_SPIBUF		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x40)
#define SPI_SPIEMU		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x44)
#define SPI_SPIDELAY	*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x48)
#define SPI_SPIDEF		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x4C)
#define SPI_SPIFMT(n)	*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x50 + (n * 4))
#define SPI_INTVEC1		*(volatile unsigned int*)(SOC_SPI_0_REGS + 0x64)
